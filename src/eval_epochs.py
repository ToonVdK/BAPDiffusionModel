...
def calculate_spatial_energy_score(real_vectors, gen_vectors):
    """
    Calculates the Spatial Energy Score. --> Similar to the bivariate energy distance
    ...
    # Internal spread of Generated (penalty for being too chaotic/wide)
...
def plot_generative_u_curve():
    ...
    for epoch in epochs_to_test:
        ...
        model_path = f"./data/model_output/unet_epoch_{epoch}"
    ...
    plt.savefig('epoch_evaluation_plot.png', dpi=300, bbox_inches='tight', facecolor='white')
    print("\nSaved 'epoch_evaluation_plot.png'!")
